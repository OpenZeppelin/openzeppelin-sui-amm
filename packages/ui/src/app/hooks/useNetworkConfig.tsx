  ...
  const fullNetworkConfig = {
    [ENetwork.LOCALNET]: {
      ...
      variables: {
        ...
        [AMM_CONFIG_VARIABLE_NAME]: LOCALNET_AMM_CONFIG_ID,
    ...
    [ENetwork.DEVNET]: {
      ...
      variables: {
        ...
        [AMM_CONFIG_VARIABLE_NAME]: DEVNET_AMM_CONFIG_ID,
    ...
    [ENetwork.TESTNET]: {
      ...
      variables: {
        ...
        [AMM_CONFIG_VARIABLE_NAME]: TESTNET_AMM_CONFIG_ID,
    ...
    [ENetwork.MAINNET]: {
      ...
      variables: {
        ...
        [AMM_CONFIG_VARIABLE_NAME]: MAINNET_AMM_CONFIG_ID,
  ...
  >((accumulator, network) => {
    accumulator[network.networkKey] = {
      ...
      variables: {
        ...
        [AMM_CONFIG_VARIABLE_NAME]:
          network.ammConfigId ?? AMM_CONFIG_ID_NOT_DEFINED,
