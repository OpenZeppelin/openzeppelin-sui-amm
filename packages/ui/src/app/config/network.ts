...
export const LOCALNET_AMM_CONFIG_ID =
  process.env.NEXT_PUBLIC_LOCALNET_AMM_CONFIG_ID || AMM_CONFIG_ID_UNDEFINED
export const DEVNET_AMM_CONFIG_ID =
  process.env.NEXT_PUBLIC_DEVNET_AMM_CONFIG_ID || AMM_CONFIG_ID_UNDEFINED
export const TESTNET_AMM_CONFIG_ID =
  process.env.NEXT_PUBLIC_TESTNET_AMM_CONFIG_ID || AMM_CONFIG_ID_UNDEFINED
