...
Before starting development, please [create an issue](https://github.com/OpenZeppelin/openzeppelin-sui-amm/issues/new/choose) to open the discussion, validate that the PR is wanted, and coordinate overall implementation details.
...
1. Make sure your fork is up to date with the main repository:
   ...
   ```sh
   cd openzeppelin-sui-amm
   git remote add upstream https://github.com/OpenZeppelin/openzeppelin-sui-amm.git
   git fetch upstream
   git pull --rebase upstream main
   ```

   > NOTE: The directory `openzeppelin-sui-amm` represents your fork's local copy.
...
5. Go to [OpenZeppelin/openzeppelin-sui-amm](https://github.com/OpenZeppelin/openzeppelin-sui-amm) in your web browser and issue a new pull request.
...
If you have any questions, feel free to post them as an [issue](https://github.com/OpenZeppelin/openzeppelin-sui-amm/issues).

Finally, if you're looking to collaborate and want to find easy tasks to start, look at the issues we marked as ["Good first issue"](https://github.com/OpenZeppelin/openzeppelin-sui-amm/labels/good%20first%20issue).
